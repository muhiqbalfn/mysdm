                  ...
                  <tr>
                    ...
                    <td align="center">
                      ...
                      <div class="dropdown-menu" style="width: 5px;">
                        <a href="<?= base_url('PangkatAdmin/detail_berkas_tendik/'.$in->id_kp_tendik) ?>" class="dropdown-item" style="color:#1E90FF">
                          <i class="fas fa-file"></i> Berkas
                        </a>
                        <?php if($akses=='super'){ ?>
                        <a href="javascript:;" class="dropdown-item btndel" style="color:red" data="<?= $in->id_kp_tendik ?>">
  ...
  $(document).ready(function(){
    ...
    $('#btn_simpan').click(function(e){
      e.preventDefault();
        ...
        $.ajax({
            type : "POST",
            url  : "<?= base_url('PangkatAdmin/add_tendik')?>",
            dataType : "JSON",
    ...
    $('.showdata').on('click','.btndel',function(){
        ...
        function(){
            $.ajax({
                type : "POST",
                url  : "<?= base_url('PangkatAdmin/del_tendik')?>",
                dataType : "JSON",
                data : {data1:data1},
                success: function(data){
                    swal({
