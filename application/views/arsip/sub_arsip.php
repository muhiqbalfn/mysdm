  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Arsip <?= $in->sub_jenis_file ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card card-info card-outline">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  <?php foreach ($nama_sub as $in){ ?> <?= $in->sub_jenis_file ?> <?php } ?>
                </h3>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="frmArsip">
          ...
          <input type="hidden" class="form-control" readonly="readonly" name="id_sub_jenis_file" value="<?= $sess_idsub ?>">
