  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Arsip <?= $in->sub_jenis_file2 ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><?= $in->sub_jenis_file ?></li>
              <li class="breadcrumb-item"><?= $in->sub_jenis_file2 ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        <?php } ?>
            ...
            <div class="card card-info card-outline">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  <?php foreach ($nama_sub as $in){ ?> <?= $in->sub_jenis_file2 ?> <?php } ?>
                </h3>
                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php if($akses=='super' or $akses=='admin'){ ?>
                      <td>
                        <a href="javascript:;" class="btnedit" data="<?= $in->id_file2 ?>" style="color:#1E90FF"><i class="fas fa-edit"></i></a> |
                        <a href="javascript:;" class="btndel" data="<?= $in->id_file2 ?>" style="color:#CD5C5C"><i class="fas fa-trash"></i></a>
                      </td>
                      <?php } ?>
                    </tr>
                    <?php } ?>
  ...
  <div class="modal fade" id="modal-arsip">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="frmArsip">
          <input type="hidden" class="form-control" readonly="readonly" name="id_sub_jenis_file2" value="<?= $sess_idsub2 ?>">
    ...
    $('#frmArsip').submit(function(e){
      e.preventDefault();
        if ($('[name=no_file]').val() == ''){
          ...
          $.ajax({
               url:'<?php echo base_url();?>ArsipController/add_arsip2',
               type:"post",
