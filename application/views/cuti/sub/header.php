    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="<?= base_url('Cuti'); ?>" class="nav-link">Home</a>
          </li>
          <li class="nav-item">
            <a href="<?= base_url('Cuti/riwayatcuti'); ?>" class="nav-link"> Riwayat Cuti Saya</a>
          </li>

          <?php if($akses == 'fakultas'){ ?>
          <li class="nav-item">
            <a href="<?= base_url('Cuti/listcuti'); ?>" class="nav-link"> <b style="color: white">List Usulan Cuti [tembusan]</b></a>
          </li>
          <?php } ?>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
            <li><a href="<?= base_url('Cuti/gantipass'); ?>" class="dropdown-item">Rubah Password</a></li>
