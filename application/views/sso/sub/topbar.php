...
<div class="d-flex align-items-stretch flex-shrink-0">
	...
	<div class="topbar d-flex align-items-stretch flex-shrink-0">
		...
		<div class="d-flex align-items-center ms-1 ms-lg-3">
			<!--begin::Menu wrapper-->
			<div class="btn btn-icon btn-custom btn-active-light position-relative w-30px h-30px w-md-40px h-md-40px" data-bs-toggle="tooltip" title="On Progress" data-bs-html="true" data-bs-placement="bottom" id="kt_drawer_chat_toggle">
		...
		<div class="d-flex align-items-center ms-1 ms-lg-3">
			...
			<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
				...
				<div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10">
					...
					<!--end::Title-->
					<!--begin::Status-->
					<span class="badge bg-success py-2 px-3">Sub Direktorat SDM</span>
					<!--end::Status-->
				</div>
				<!--end::Heading-->
				<!--begin:Nav-->
		...
		<!--begin::Login-->
		<div class="d-flex align-items-center ms-1 ms-lg-3">
			<a href="#" class="btn btn-custom btn-color-white btn-active-color-success my-2 me-2 me-lg-4" data-bs-toggle="modal" data-bs-target="#modal_login">
				<i class="fas fa-sign-in-alt fs-4 me-2"></i> Login
			</a>
		</div>
		<!--end::Login-->
		...
		<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
			...
			<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
				<img src="https://i-sdm.unesa.ac.id/assets/images/kepegawaian/pegawai/<?= $nip ?>.jpg" style="width: 40px; margin-left:10px;">
			</div>
			...
			<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-400px" data-kt-menu="true">
				...
				<div class="menu-item px-3">
					<div class="menu-content d-flex align-items-center px-3">
						...
						<div class="symbol symbol-50px me-5">
							<img src="https://i-sdm.unesa.ac.id/assets/images/kepegawaian/pegawai/<?= $nip ?>.jpg" style="width: 45px;">
						</div>
						<!--end::Avatar-->
						<!--begin::Username-->
						<div class="d-flex flex-column">
							<span class="badge badge-light-success fw-bolder fs-7 px-2 py-1 ms-2"><?php if($akses!=''){echo $akses;}else{echo 'Pegawai';} ?></span>
							<div class="fw-bolder d-flex align-items-center fs-5"><?= $namapeg ?></div>
				...
				<!--begin::Menu item-->
				<div class="menu-item px-5">
					<a href="<?= base_url('Controller/profil') ?>" class="menu-link px-5">Profil</a>
				</div>
				<!--end::Menu item-->
				...
				<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
					<a href="#" class="menu-link px-5">
						...
						<img class="w-15px h-15px rounded-1 ms-2" src="<?= base_url() ?>assets/sso/media/flags/indonesia.svg" alt="" /></span></span>
					</a>
					<!--begin::Menu sub-->
					<div class="menu-sub menu-sub-dropdown w-175px py-4">
						...
						<div class="menu-item px-3">
							...
							<span class="symbol symbol-20px me-4">
								<img class="rounded-1" src="<?= base_url() ?>assets/sso/media/flags/indonesia.svg" alt="" />
							</span>Indonesia</a>
						</div>
						<!--end::Menu item-->
						<!--begin::Menu item-->
						<div class="menu-item px-3">
							...
							<span class="symbol symbol-20px me-4">
								<img class="rounded-1" src="<?= base_url() ?>assets/sso/media/flags/united-states.svg" alt="" />
							</span>English</a>
						</div>
						<!--end::Menu item-->
						<!--begin::Menu item-->
						<div class="menu-item px-3">
							<a href="#" class="menu-link d-flex px-5">
							<span class="symbol symbol-20px me-4">
								<img class="rounded-1" src="<?= base_url() ?>assets/sso/media/flags/spain.svg" alt="" />
							</span>Spanish</a>
						</div>
						<!--end::Menu item-->
						<!--begin::Menu item-->
						<div class="menu-item px-3">
							<a href="#" class="menu-link d-flex px-5">
							<span class="symbol symbol-20px me-4">
								<img class="rounded-1" src="<?= base_url() ?>assets/sso/media/flags/germany.svg" alt="" />
							</span>German</a>
						</div>
						<!--end::Menu item-->
						<!--begin::Menu item-->
						<div class="menu-item px-3">
							<a href="#" class="menu-link d-flex px-5">
							<span class="symbol symbol-20px me-4">
								<img class="rounded-1" src="<?= base_url() ?>assets/sso/media/flags/japan.svg" alt="" />
							</span>Japanese</a>
						</div>
						<!--end::Menu item-->
						<!--begin::Menu item-->
						<div class="menu-item px-3">
							<a href="#" class="menu-link d-flex px-5">
							<span class="symbol symbol-20px me-4">
								<img class="rounded-1" src="<?= base_url() ?>assets/sso/media/flags/france.svg" alt="" />
							</span>French</a>
						</div>
						<!--end::Menu item-->
					</div>
				...
				<!--begin::Menu item-->
				<div class="menu-item px-5">
					<a href="<?= base_url('Controller/logout') ?>" class="menu-link px-5">Sign Out</a>
				</div>
				<!--end::Menu item-->
