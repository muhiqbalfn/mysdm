				...
				<div class="card-body">
					...
					<div class="row gy-5 g-xl-8">
						<div class="col-xxl-12">
							<h3 class="card-title fw-bolder text-gray-800 fs-2">DOKUMEN</h3><br>
								...
								<table id="datatable" class="table table-striped table-hover table-bordered table-row-bordered gy-5 gs-7">
								    ...
								    <tbody>
								        ...
								        <tr>
								            <td><?= $no ?>.</td>
								            <td>
								            	<a href="<?= base_url('assets/dokumen/dokumen/'.$in->file); ?>" target="_blank" style="margin-right: -30px;">
								            		<img class="w-25px" src="<?= base_url() ?>assets/sso/pdf.png"/>
								            	</a>
								            </td>
								            <td>
								            	<a href="<?= base_url('assets/dokumen/dokumen/'.$in->file); ?>" target="_blank"><?= $in->ket ?></a><br>
								            	file(s)
								            </td>
								            <td>Dokumen</td>
								            <td><?= $in->tgl ?></td>
