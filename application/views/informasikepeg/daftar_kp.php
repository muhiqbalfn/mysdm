  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Daftar Usul Kenaikan Pangkat dan Jabatan Dosen</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('Controller') ?>">Home</a></li>
              <li class="breadcrumb-item active">Daftar usul pangkat dan jabatan dosen</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if($akses=='admin'){ ?>
                    <a href="#" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#modal-kj"><i class="fas fa-plus"></i> &nbsp;Tambah Data </a>
                  <?php } ?>
                </div>
              </div>
              <!-- /.card-header -->
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <?php 
                          ...
                          else if($in->status=='Diusulkan'){echo'btn-primary';}
			  else if($in->status=='SK Terbit'){echo'btn-success';}
			  else if($in->status=='Selesai'){echo'btn-success';}
                          else if($in->status=='Proses penilaian'){echo'btn-warning';}
                          else if($in->status=='Dokumen tidak lengkap'){echo'btn-danger';}
			  else if($in->status=='Perlu Revisi'){echo'btn-danger';}
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if($akses=='admin'){ ?>
                    <a href="#" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#modal-kp"><i class="fas fa-plus"></i> &nbsp;Tambah Data </a>
                  <?php } ?>
                </div>
              </div>
              <!-- /.card-header -->
      ...
      <div class="modal-content">
        ...
        <form class="user">
          <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="usulan_kj" style="width: 100%;">
                        <option value="Dosen/Tenaga Pengajar">Dosen/Tenaga Pengajar</option>
                        <option value="Asisten Ahli">Asisten Ahli</option>
                        <option value="Lektor">Lektor</option>
                        <option value="Lektor Kepala">Lektor Kepala</option>
			...
			<option value="Menunggu persetujuan senat">Menunggu persetujuan senat</option>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Jabatan</label>
                      <select class="form-control select2" name="jabatan1" style="width: 100%;">
                        <option value="Dosen/Tenaga Pengajar">Dosen/Tenaga Pengajar</option>
                        <option value="Asisten Ahli">Asisten Ahli</option>
                        <option value="Lektor">Lektor</option>
                        <option value="Lektor Kepala">Lektor Kepala</option>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Usulan Jabatan</label>
                      <select class="form-control select2" name="usulan_kj1" style="width: 100%;">
                        <option value="Dosen/Tenaga Pengajar">Dosen/Tenaga Pengajar</option>
                        <option value="Asisten Ahli">Asisten Ahli</option>
                        <option value="Lektor">Lektor</option>
                        <option value="Lektor Kepala">Lektor Kepala</option>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Jabatan</label>
                      <select class="form-control select2" name="jabatan_kp" style="width: 100%;">
                        <option value="Dosen/Tenaga Pengajar">Dosen/Tenaga Pengajar</option>
                        <option value="Asisten Ahli">Asisten Ahli</option>
                        <option value="Lektor">Lektor</option>
                        <option value="Lektor Kepala">Lektor Kepala</option>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Jabatan</label>
                      <select class="form-control select2" name="jabatan_kp1" style="width: 100%;">
                        <option value="Dosen/Tenaga Pengajar">Dosen/Tenaga Pengajar</option>
                        <option value="Asisten Ahli">Asisten Ahli</option>
                        <option value="Lektor">Lektor</option>
                        <option value="Lektor Kepala">Lektor Kepala</option>
  ...
  $(document).ready(function(){
    ...
    $('#btn_simpan').click(function(e){
        ...
        if ($('[name=nip]').val() == ''){
            ...
            $.ajax({
                type : "POST",
                url  : "<?= base_url('KJController/add_kj')?>",
                dataType : "JSON",
                data : {data1:data1,
                        data2:data2,
                        data3:data3,
  ...
  $(document).ready(function(){
    ...
    $('#btn_simpan_kp').click(function(e){
        ...
        if ($('[name=nip_kp]').val() == ''){
            ...
            $.ajax({
                type : "POST",
                url  : "<?= base_url('KPController/add_kp')?>",
                dataType : "JSON",
                data : {data1:data1,
                        data2:data2,
                        data3:data3,
