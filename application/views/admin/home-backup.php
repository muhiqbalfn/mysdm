        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="<?= base_url('HK/daftar_kp') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a><br>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
              ...
              <a href="<?= base_url('HK/daftar_kp_tendik') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a><br>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                <ul class="users-list clearfix">
                  <?php foreach ($get_user as $in){ ?>
                  <li>
                    <img src="<?=base_url('assets/')?>dist/img/user1-128x128.jpg" alt="User Image">
                    <a class="users-list-name" href="#"><?= $in->nama_user ?></a>
...
$(function () { 
    var data_aa  = <?php echo $aa1; ?>;
    var data_l   = <?php echo $l1; ?>;
    var data_lk  = <?php echo $lk1; ?>;
    var data_gb  = <?php echo $gb1; ?>;

    $('#grafik-kj').highcharts({
        chart: {
            type: 'column'
        },
        title: {
