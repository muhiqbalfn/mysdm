...
?> 
  ...
  <nav class="main-header navbar navbar-expand-md navbar-info navbar-dark">
    <div class="container">
      <a href="<?= base_url('Tubel'); ?>" class="navbar-brand">
        <img src="<?=base_url('assets/')?>hk1.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">My-Monitoring <b>Tubel</b></span>
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="<?= base_url('Tubel'); ?>" class="nav-link">Home</a>
          </li>
          <li class="nav-item">
            <a href="<?= base_url(''); ?>" class="nav-link"> List</a>
          </li>
        </ul>
      </div>
